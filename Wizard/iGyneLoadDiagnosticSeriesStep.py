...
class iGyneSegmentROIStep( iGyneStep ) :
  ...
  def __init__( self, stepid ):
    ...
    self.__parent = super( iGyneSegmentROIStep, self )
...
#    self.buttonBoxHints = self.ButtonBoxHidden
  ...
  def onExit(self, goingTo, transitionType):
    ...
    super(iGyneSegmentROIStep, self).onExit(goingTo, transitionType)

  def onEntry(self, comingFrom, transitionType):
    '''
    Update GUI and visualization
    '''
    super(iGyneSegmentROIStep, self).onEntry(comingFrom, transitionType)
