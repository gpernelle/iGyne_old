...
class iGyneReportROIStep( iGyneStep ) :
  ...
  def __init__( self, stepid ):
    ...
    self.__parent = super( iGyneReportROIStep, self )
...
#    self.buttonBoxHints = self.ButtonBoxHidden
  ...
  def onEntry(self, comingFrom, transitionType):
    ...
    super(iGyneReportROIStep, self).onEntry(comingFrom, transitionType)
  ...
  def onExit(self, goingTo, transitionType):
    ...
    super(iGyneReportROIStep, self).onExit(goingTo, transitionType)
