...
class iGyneSelectProcedureStep( iGyneStep ) :
  ...
  def createUserInterface( self ):
    ...
    #groupboxLayout = qt.QFormLayout(TemplateSheetWidget)
    for i in range(43):
  ...
  #------------------------------------------------------------------------------------
    ...
    # TemplateSheetLayout.setVerticalSpacing(700)
    # TemplateSheetLayout.addWidget(t)
    # TemplateSheetLayout.addWidget(t2)
    # TemplateSheetLayout.addWidget(t3)
    # TemplateSheetLayout.addWidget(t4)
    # TemplateSheetLayout.addWidget(t5)
...
#------------------------------------------------------------------------------------
  ...
  def loadTemplate(self):
    ...
    # self.loadTemplatePushButton.setEnabled(0)
